...
import pytest
from models import Entry, Feed, Category, ArticleInput, is_single_sentence_summary
...
async def test_summary_detection_and_fetching_integration():
    ...
    article = await ArticleInput.from_entry(short_summary_entry, fetch_full_content=False)

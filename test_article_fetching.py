...
from models import (
    Entry, Feed, Category, ArticleInput, 
    is_single_sentence_summary, fetch_article_content
)
...
class TestSingleSentenceSummaryDetection:
    ...
    def test_summary_keywords(self):
        ...
        with_summary_keyword = "This is a brief summary of the article content and main points."
...
class TestArticleContentFetching:
    ...
    async def test_successful_fetch(self):
        ...
        with patch('models.requests.get', return_value=mock_response):
    ...
    async def test_request_failure(self):
        ...
        with patch('models.requests.get', side_effect=Exception("Network error")):
            content = await fetch_article_content("https://example.com/article")
...
class TestArticleInputWithFetching:
    ...
    async def test_fetch_when_summary_detected(self):
        ...
        with patch('models.fetch_article_content', new_callable=AsyncMock) as mock_fetch:
